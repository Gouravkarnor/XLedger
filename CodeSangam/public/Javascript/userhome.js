...
//     .getElementById("changeright")
//     .classList.contains("right-column-lightcolor");
//   console.log(check);
//   if (check) {
//     // right
//     document
//       .getElementById("changeright")
//       .classList.remove("right-column-lightcolor");
//     document
//       .getElementById("changeright")
//       .classList.add("right-column-darkcolor");

//     //left
//     document.getElementById("changeleft").classList.remove("left-column-light");
//     document.getElementById("changeleft").classList.add("left-column-dark");
//   } else {
//     // right
//     document
//       .getElementById("changeright")
//       .classList.remove("right-column-darkcolor");
//     document
//       .getElementById("changeright")
//       .classList.add("right-column-lightcolor");

//     // left
//     document.getElementById("changeleft").classList.add("left-column-light");
//     document.getElementById("changeleft").classList.remove("left-column-dark");
//   }
// }
